    ...
    <div className="w-full mt-4">
      <div className="grid grid-cols-1 gap-2">
        {recruitData && recruitData.length > 0 ? (
          ...
          <div className="w-full h-80 flex items-center justify-center bg-white rounded-xl border border-gray-100">
            <p className="text-gray-500 text-sm">진행중인 외주가 없습니다.</p>
          </div>
        )}
      </div>
    </div>
