...
const DesktopCategoryMenu = () => (
  <div className="hidden lg:block w-60 h-auto border border-gray-200 rounded-lg p-4 bg-white shadow-sm overflow-y-auto">
    ...
    {secondCategories.map((second) => {
      const isSelectedSecond = selectedCategories?.secondCategoryId === second.second_category_id;
      const isSelectedFirst = selectedCategories?.firstCategoryId === second.first_category_id;
                  ...
                  return (
                    <div 
                      ...
                      className={`py-1 px-2 text-xs rounded cursor-pointer transition-colors ${
                        isSelectedThird
                          ? 'bg-yellow-50 text-yellow-point'
                          : 'text-gray-600 hover:text-yellow-point hover:bg-yellow-50'
                      }`}
                ...
                return (
                  <div
                    ...
                    className={`p-3 cursor-pointer transition-colors ${
                      ...
                      isSelectedSecond || 
                      (second.first_category_id === 6 && isSelectedFirst)
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 cursor-pointer transition-colors ${
                        isSelectedThird
                          ? "bg-yellow-point text-white"
                          : "hover:bg-yellow-50 hover:text-yellow-point text-gray-700"
                      }`}
