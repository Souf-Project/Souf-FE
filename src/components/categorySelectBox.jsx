...
export default function CategorySelectBox({title, content, defaultValue = "", type}) {
  ...
  // 옵션 데이터 구조
  const options = [
    { id: 1, name: "순수 미술 & 일러스트", subOptions: [
      { id: 11, name: "일러스트·캐릭터 디자인", subOptions: [
        { id: 111, name: "일러스트" },
        { id: 112, name: "캐리커쳐" },
        { id: 113, name: "웹툰·콘티" },
        { id: 114, name: "2D 캐릭터" },
    ...
    { id: 2, name: "만들기", subOptions: [
        { id: 21, name: "시제품 디자인", subOptions: [
          { id: 211, name: "시제품·3D프린팅" },
          { id: 212, name: "기타" },
        ]},
        { id: 22, name: "산업·제품 디자인", subOptions: [
        ...
        { id: 23, name: "패션·텍스타일 디자인", subOptions: [
          { id: 231, name: "의류·쥬얼리 디자인" },
          { id: 232, name: "텍스타일 디자인" },
          { id: 233, name: "3D 도식화" },
          { id: 234, name: "기타" },
        ]},
        { id: 24, name: "조형 예술", subOptions: [
            { id: 241, name: "도예·도자기" },
            { id: 242, name: "조형" },
      ...
      { id: 3, name: "음악", subOptions: [
        { id: 31, name: "음향", subOptions: [
          { id: 311, name: "성우" },
      ...
      { id: 4, name: "사진 · 영상 · 영화", subOptions: [
        { id: 41, name: "사진", subOptions: [
      ...
      { id: 5, name: "디지털 콘텐츠 & 그래픽 디자인", subOptions: [
        { id: 51, name: "브랜드 디자인", subOptions: [
          { id: 511, name: "로고 디자인" },
          { id: 512, name: "브랜드 디자인·가이드" },
          { id: 513, name: "기타" },
        ]},
        { id: 52, name: "산업 디자인", subOptions: [
          { id: 521, name: "명함" },
        ...
        { id: 53, name: "웹·모바일 디자인", subOptions: [
          { id: 531, name: "웹 UI·UX" },
          { id: 532, name: "앱·모바일 UI·UX" },
          { id: 533, name: "기타" },
        ]},
        { id: 54, name: "마케팅 디자인", subOptions: [
          { id: 541, name: "상세 페이지" },
        ...
        { id:55, name: "컴퓨터 그래픽(CG)·모션그래픽", subOptions: [
          { id:551, name: "모션그래픽" },
          { id:552, name: "인포그래픽" },
          { id:553, name: "미디어 아트" },
          { id:554, name: "인트로·로고" },
        ...
        { id: 56, name: "게임 디자인", subOptions: [
          { id: 561, name: "VR·AR·게임" },
          { id: 562, name: "메타버스" },
          { id: 563, name: "3D 게임용 소스" },
          { id: 564, name: "기타" },
        ]},
        { id: 57, name: "애니메이션", subOptions: [
