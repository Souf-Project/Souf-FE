...
export default function ReceiverMessage({ content, createdTime, opponentProfileImageUrl, type = "TALK", fileName, onImageClick, onFileClick, opponentId, opponentRole }) {
        ...
        <div className="max-w-xs bg-gray-200 text-black px-4 py-2 rounded-lg rounded-bl-none shadow">
          {type === "IMAGE" ? (
            ...
            <div 
              ...
              onClick={() => onFileClick && onFileClick(S3_BUCKET_URL + content, fileName)}
            >
              <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <span className="text-sm text-gray-700 truncate">{fileName || content.split('/').pop()}</span>
            </div>
          ) : (
