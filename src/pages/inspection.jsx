...
export default function Inspection() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full flex flex-col items-center justify-center border-4 border-[#3181D2] rounded-lg p-12">
        <div className="flex items-center justify-start w-full border-b-4 border-gray-300 pb-6">
        <img src={SouFLogo} alt="SouFLogo" className="w-48 mr-auto" />
        </div>
        <div className="flex flex-col items-center justify-center gap-2 my-12 font-medium text-2xl">
            <p className="text-4xl">스프 점검 안내</p>
            <p>더 나은 서비스를 위해 현재 서버 점검을 진행하고 있습니다.</p>
            <p>잠시만 기다려 주세요. 이용에 불편을 드려 죄송합니다.</p>
